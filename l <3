...
<body>
    <div id="question">Namora comigo?</div>
    <div id="options">
        <div id="noContainer">
            <a href="https://youtu.be/TQ5DUv_ZwRg?si=QzH6oMBz6FMMdsRT"><button id="yes" class="button">Sim</button></a>
    ...
    <script>
        ...
        function moveNoButton() {
            var containerWidth = (noContainer.offsetWidth - noButton.offsetWidth)*6;
            var containerHeight = (noContainer.offsetHeight - noButton.offsetHeight)*6;
